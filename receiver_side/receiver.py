...
'''Files are gonna be stored in teh received_files folder so we can check it globally'''
    ...
    while True:
        try:
            ...
            for _ in range(num_files):
                ...
                new_file_name = saving_dir + new_file_name.split('/')[-1] # e.g. /home/sachin/Desktop/all/projects/tyler/fam_12-29-24-20-38-35.mp3
...
# Example usage
# files_to_send = ["file1.txt", "file2.jpg", "data.csv"]  # List of files to send
# sending(files_to_send)
